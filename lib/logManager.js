...
// BUG9 FIX: stopTailWatcher defined at module level, NOT inside startTailWatcher
...
function startTailWatcher(onEntry, options = {}) {
  ...
  // BUG9 FIX: if emitExisting, run first tick BEFORE starting interval
...
} // ← startTailWatcher closes here — correctly
